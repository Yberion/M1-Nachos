/*! \file  main.cpp 
 ...
 //              -z -f <configfile>
 //
 //    -d causes certain debugging messages to be printed (cf. utility.hpp)
...
int main(int argc, char **argv)
{
    ...
    { // copy from UNIX to Nachos
        ...
        {
            if ((strlen(g_cfg->ToCopyUnix[i]) != 0) && (strlen(g_cfg->ToCopyNachos[i]) != 0))
