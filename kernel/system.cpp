...
ObjId *g_object_ids; //!< list of system objects (used in exception.cpp to verify existence of semas, conditions, files ...
...
void Initialize(int argc, char **argv)
{
    ...
    {
        fprintf(stderr, "Nachos boot error: cannot allocate process\n");
        Exit(-1);
    }
