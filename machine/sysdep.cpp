...
//----------------------------------------------------------------------
static void InitSocketName(struct sockaddr_in *uname, char *name)
{
...
//----------------------------------------------------------------------
int ReadFromSocket(int sockID, char *buffer, int packetSize)
{
    int retVal;
//    extern int errno;
    struct sockaddr_in uName;
 ...
 */
//----------------------------------------------------------------------
void DeallocBoundedArray(int8_t *ptr, size_t size)
{
    delete[] ptr;
    /*
