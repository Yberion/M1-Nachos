 ...
 */
static char *exceptionNames[] = { (char*)"no exception", (char*)"syscall", (char*)"page fault", (char*)"page read only", (char*)"bus error",
        (char*)"address error", (char*)"overflow", (char*)"illegal instruction" };
...
{
    if (host_endianess == mips_endianess)
        return word;
...
void Machine::DumpState()
{
    ...
    for (i = 0; i < NUM_GP_REGS; i++)
        ...
        {
            case STACK_REG:
                printf("\tSP(%d):\t0x%x%s", i, int_registers[i], ((i % 4) == 3) ? "\n" : "");
                break;

            case RETADDR_REG:
                printf("\tRA(%d):\t0x%x%s", i, int_registers[i], ((i % 4) == 3) ? "\n" : "");
                break;

            default:
                printf("\t%d:\t0x%x%s", i, int_registers[i], ((i % 4) == 3) ? "\n" : "");
                break;
        }
